...
import type { ComputedFn, NodesComputed, PageState, SplitInfo, SplitParams } from '@/extension/page/types'
import { BULLETLIST, CASSIE_BLOCK, CASSIE_BLOCK_EXTEND, EXTEND, HEADING, LISTITEM, ORDEREDLIST, PAGE, PARAGRAPH, TABLE, TABLE_ROW } from '@/extension/nodeNames'
...
export class PageComputedContext {
  ...
  run() {
    if (this.isRunning)
      return this.tr // Prevent re-entry
