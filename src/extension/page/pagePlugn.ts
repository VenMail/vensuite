...
// @ts-expect-error
import { PageComputedContext, defaultNodesComputed } from '@/extension/page/computed'
import type { PageOptions } from '@/extension/page/types'
import { PageState } from '@/extension/page/types'
...
export function pagePlugin(editor: Editor, bodyOption: PageOptions) {
