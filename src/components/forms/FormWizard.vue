...
const quickTemplates = [
  {
    ...
    form: {
      ...
      blocks: [
        makeBlock({ type: "short", category: "text", question: "Full Name", placeholder: "Full name", required: true }),
        makeBlock({ type: "email", category: "text", question: "Email Address", placeholder: "name@example.com", required: true }),
  ...
  },
  {
    ...
    form: {
      ...
      blocks: [
        ...
        makeBlock({ type: "select", category: "choice", question: "Product", options: ["Core plan", "Team plan", "Enterprise plan"], required: true }),
