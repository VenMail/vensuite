...
// ```
export function findParentDomRef(predicate, domAtPos) {
  return (selection) => {
    const parent = findParentNode(predicate)(selection)
    if (parent) {
...
// }
// ```
export function hasParentNode(predicate) {
  return (selection) => {
...
// ```
export function findParentNodeOfTypeClosestToPos($pos, nodeType) {
...
// }
// ```
export function hasParentNodeOfType(nodeType) {
  return (selection) => {
...
// ```
export function findParentDomRefOfType(nodeType, domAtPos) {
  return (selection) => {
...
// ])(selection);
// ```
export function findSelectedNodeOfType(nodeType) {
  return (selection) => {
...
// ```
export function findPositionOfNodeBefore(selection) {
...
// ```
export function findDomRefAtPos(position, domAtPos) {
